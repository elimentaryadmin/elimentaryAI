...
const defaultConfig = {
  ...
  // wren engine
  wrenEngineEndpoint: 'http://35.223.0.153:8080',
  //wrenEngineEndpoint: 'http://172.19.0.2:8080',

  // wren AI
  wrenAIEndpoint: 'http://35.223.0.153:5555',

  // ibis server
  experimentalEngineRustVersion: true,
  ibisServerEndpoint: 'http://35.223.0.153:8000',
 // ibisServerEndpoint: 'http://172.19.0.2:8000',
